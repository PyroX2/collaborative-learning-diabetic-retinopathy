...
masks_path = 'datasets/segmentation/segmentation_ground_truths/'
...
def fundus_fitting(frame):
    ...
    return processed_frame, top_pad, bottom_pad
...
for i in range(len(images)):
    ...
    processed_frame, top_pad, bottom_pad = fundus_fitting(image)
