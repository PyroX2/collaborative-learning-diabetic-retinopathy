...
LOG_NAME = 'segformer_pretrain'

DATASET_DIR = '/users/scratch1/s189737/collaborative-learning-diabetic-retinopathy/datasets/processed_segmentation_dataset'

# Directory where checkpoints are saved
CHECKPOINT_DIR = '/users/scratch1/s189737/collaborative-learning-diabetic-retinopathy/models/checkpoints/segmentation'
...
def train(train_dataset, val_dataset, epochs, generator_model):
    ...
    for epoch in range(epochs):
        ...
        for train_batch in tqdm(train_dataloader):
            ...
            px_level_output_masks = F.sigmoid(px_level_output_masks)

            px_level_output_masks = postprocess_transform(px_level_output_masks)
